...
The `causal-ts` maintainers take all security issues in the project
seriously. Thank you for improving the security of `causal-ts`. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

`causal-ts` leverages GitHub's private vulnerability reporting.
